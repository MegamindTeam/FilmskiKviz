    ...
    <section id="services">
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-lg-12 text-center">
                    <form id="dodajpitanjeVJ-form" method="post" action="<?php echo base_url();?>index.php/Moderator/dodajPitanjeVJ">
                  ...
                  <?php echo "<div class=\"row text-center\" style='color:red;'>
                   ...
                   <div class="form-group row">
                        ...
                        <div class="form-group row">
                    <label class="col-sm-2">Tačan odgovor</label>
                    <div class="col-sm-1">
                      <div class="checkbox">
                        <label>
                          <input type="radio" name="tacni" value="1" checked> 1
                        </label>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-1">
                      <div class="checkbox">
                        <label>
                          <input type="radio" name="tacni" value="2"> 2
                        </label>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-1">
                      <div class="checkbox">
                        <label>
                          <input type="radio" name="tacni" value="3"> 3
                        </label>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-1">
                      <div class="checkbox">
                        <label>
                          <input type="radio" name="tacni" value="4"> 4
                        </label>
                      </div>
                    </div>
					...
					<div class="col-sm-1">
                      <div class="checkbox">
                        <label>
                          <input type="radio" name="tacni" value="5"> 5
                        </label>
                      </div>
                    </div>
					...
					<div class="col-sm-1">
                      <div class="checkbox">
                        <label>
                          <input type="radio" name="tacni" value="6"> 6
                        </label>
                      </div>
                    </div>
					...
					<div class="col-sm-1">
                      <div class="checkbox">
                        <label>
                          <input type="radio" name="tacni" value="7"> 7
                        </label>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-1">
                      <div class="checkbox">
                        <label>
                          <input type="radio" name="tacni" value="8"> 8
                        </label>
                      </div>
                    </div>
