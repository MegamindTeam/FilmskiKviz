...
<head>
    ...
    <title>Megamind kviz | Profil </title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Vaš profil</h2>
                    <h3 class="section-subheading text-muted">Možete menjati sve podatke osim <b>korisničkog imena</b>. </h3>
                </div>
            </div>
            <!-- row 1-->
            <div class="row">
            	<!-- column 1-->
                <div class="col-lg-4">
                  <img class="img-circle" src="<?php echo base_url();?>projekatPSI/img/sheep.png" alt="Generic placeholder image" width="140" height="140">
                 
                  
                </div>
                <!-- //column 1 -->
				 <img src="<?php echo base_url();?>projekatPSI/img/crown.png">
                 <h2>Trenutni rang : <?php echo $data['records'][0]->rank;?> </h2>
                  <p><?php
                      $c = $err['e_nalog'];
                      echo "<div class='row text-center' style='color:red;'>
                        <div class='col-lg-12 text-center'>
                         $c<br><br>
                        </div>
                    </div> ";?>
         ...
         <!--row2 -->
         <div class="row">
             <form id="profil-form" method="post" action="<?php echo base_url();?>index.php/Igrac/izmeniProfil">
         	<div class="col-lg-12 text-center">
                <form>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 form-control-label">Korisničko ime</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName" name="inputName"  placeholder="<?php echo $data['records'][0]->username;?>" readonly>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="email" class="form-control" id="inputEmail3" name="inputEmail3" placeholder="<?php echo $data['records'][0]->email;?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 form-control-label">Nova lozinka</label>
                    <div class="col-sm-10">
                      <input type="password" class="form-control" id="inputPassword" name="inputPassword" placeholder="Upisi Lozinku">
                    </div>
                  </div>

                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 form-control-label">Potvrdi lozinku</label>
                    <div class="col-sm-10">
                      <input type="password" class="form-control" id="inputPasswordAgain" name="inputPasswordAgain" placeholder="Potvrdi Lozinku">
                    </div>
                  </div>
