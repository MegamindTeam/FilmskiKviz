        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Pitanje sa slikom i više ponuđenih i više tačnih odgovora.</h3>
                </div>
            </div>
            <div class="row text-center">
                <div class="col-lg-12 text-center">
                	<form  id="dodajpitanjeVV-form" enctype="multipart/form-data" method="post" action="<?php echo base_url();?>index.php/Moderator/dodajPitanjeS">
                 <?php echo $e_uspeh?>
                  ...
                  <?php echo "<div class=\"row text-center\" style='color:red;'>
                   ...
                   <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                                <input type="file" class="form-control-file" id="exampleInputFile" name="slika">
                            </div>
                    </div>
                </div>
                  <div class="form-group row">
