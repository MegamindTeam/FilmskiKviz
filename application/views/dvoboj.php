...
<script>
    ...
    function writeTimeLeft(){
        ...
        timerValue--;
        if (timerValue == 1) clearInterval(timerRet);
    }
    ...
    function zovi(){
        ...
        zoviUloziPoene(); //otvori str za ulaganje poena
    ...
    function klik(){
        ...
        $.ajax({
            ...
            type: "post",
            url: "<?php echo base_url();?>index.php/Igrac/zapocniDvoboj",
            cache: false,
            dataType: 'html',
            data: $('#formaUlog').serialize(),
    ...
    function zoviUloziPoene(){
        $.ajax({
            type: "post",
            url: "<?php echo base_url();?>index.php/Igrac/uloziPoene",
            cache: false,
            dataType: 'html',
    ...
    function pokupiIDohvatiPitanje(){
        $.ajax({
            type: "post",
            url: "<?php echo base_url();?>index.php/Igrac/sledecePitanje_dvoboj",
            cache: false,
            dataType: 'html',
            data: $('#formaPitanje').serialize(),
            success: function (pitanje) {
    ...
    function callFinishPage(){
        $.ajax({
            type: "post",
            url: "<?php echo base_url();?>index.php/Igrac/zavrsenaIgra_dvoboj",
            cache: false,
            dataType: 'html',
            data: $('#formaPitanje').serialize(),
            success: function (pitanje) {
